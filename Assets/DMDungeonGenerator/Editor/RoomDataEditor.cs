...
public class RoomDataEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        data.debugTransparency = EditorGUILayout.Slider(data.debugTransparency, 0f, 1f);
    ...
    private void DrawDoorEditingHandles(List<Voxel> vox)
    {
        ...
        for (int i = 0; i < vox.Count; i++)
        {
            ...
            DrawDoorButtonArrow(pos, Vector3.forward, 0.4f, 0, 1);
            DrawDoorButtonArrow(pos, Vector3.back, 0.4f, 0, 1);
            DrawDoorButtonArrow(pos, Vector3.left, 0.4f, 0, 1);
            DrawDoorButtonArrow(pos, Vector3.right, 0.4f, 0, 1);
        }
    }
    ...
    private void DrawArrowButton(Vector3 pos, Vector3 dir, float handleSize, float iO, float iS)
    {
        ...
        Vector3 worldPos = rd.transform.TransformPoint(
            pos * voxelScale + dir * (iO + 0.5f) * voxelScale
        );
